<template>
 ...
 <!--        Take the original content of currentSection, add the text of the boilerplate (currentBoilerplate) to it, and then update in the database, add to currentSection content.
        Create a button that adds it together - so v-on:click concatenate {{currentSection + currentBoilerplate}}  -->
